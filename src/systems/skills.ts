...
export const SKILLS: ReadonlyArray<SkillDef> = [
  ...
  // Sealwarden kit — v0.10.0. Post-Act-III unlock per spec §4.2. 3 working
  // (Smite basic / Consecrate aoe / Aegis mobility), 3 stubbed.
  {
    id: 'sw-smite',
    name: 'Smite',
    icon: '✠',
    ...
    cooldownMs: 0,
    damageMul: 1.0,
    summary: 'Sealed strike. Builds Vigil on every landed hit. Left-click.',
    implemented: true,
  },
  {
    id: 'sw-consecrate',
    ...
    cooldownMs: 1700,
    damageMul: 0.7,
    summary: 'Hallowed pulse — every adjacent enemy takes radiant damage. Costs 30 Vigil.',
    implemented: true,
  },
  {
    id: 'sw-aegis',
    ...
    cooldownMs: 5000,
    damageMul: 0,
    summary: 'Step under your aegis — dash up to 4 tiles toward your goal. Costs 30 Vigil.',
    implemented: true,
  },
  {
    id: 'sw-sanctify',
    ...
    cooldownMs: 12000,
    damageMul: 0,
    summary: '[v0.10.x] Drop a Vigil ground — heal-over-time within. Effect lands in v0.10.x.',
    implemented: false,
  },
  {
    id: 'sw-wrath',
    ...
    cooldownMs: 6000,
    damageMul: 2.8,
    summary: '[v0.10.x] Finisher — colossal damage. Costs 55 Vigil. Lands in v0.10.x.',
    implemented: false,
  },
  {
    id: 'sw-final-verse',
    ...
    cooldownMs: 0,
    damageMul: 0,
    summary: '[v0.10.x] Passive — at low HP, regen Vigil x3. Defined; effect lands in v0.10.x.',
    implemented: false,
  },
];
